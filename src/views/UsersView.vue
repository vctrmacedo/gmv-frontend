    ...
    <div class="page-header">
      <div class="header-content">
        <div class="header-icon">
          <v-avatar size="60" class="gradient-users elevation-4">
            <v-icon size="30" color="white">mdi-account-group</v-icon>
          </v-avatar>
        </div>
        <div class="header-text">
          <h1 class="page-title">Gerenciar Usuários</h1>
          <p class="page-subtitle">Controle total sobre usuários do sistema</p>
        </div>
      </div>
    </div>
        ...
        >
          ...
          <template #no-data>
            <div class="no-data">
              ...
              <div class="no-data-text">Nenhum usuário encontrado</div>
            </div>
          </template>
        </v-data-table>
      </div>
    ...
    <v-dialog v-model="editDialog" max-width="520" persistent>
      <div class="custom-dialog">
        <div class="dialog-header">
          ...
          <span class="dialog-title">Editar Usuário</span>
        </div>
    ...
    <v-dialog v-model="deleteDialog" max-width="420" persistent>
      <div class="custom-dialog">
        <div class="dialog-header danger">
          ...
          <span class="dialog-title">Excluir Usuário</span>
        </div>
        <div class="dialog-content">
